...
gulp.task('move-main-js', function() {
...
gulp.task('move-html', function() {
    ...
    return gulp.src(indexPath)
        .pipe(cheerio(function($) {
            $('script').remove();
            $('link').remove();
            $('body').append('<script src="../js/lib.js"></script>');
...
gulp.task('dist', function(cb) {
    runSequence('clean', ['move-main-js', 'concat-js', 'concat-css', 'move-html']);
});
